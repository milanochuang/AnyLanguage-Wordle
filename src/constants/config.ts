export const CONFIG = {
  ...
  language: '所有腔調的客家話', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Milan', // Put your name here so people know who made this Wordle!
  authorWebsite: 'https://milanochuang.github.io', // Put a link to your website or social media here
  wordListSource: '教育部臺灣客家語常用詞辭典', // Describe the source material for your words here
  wordListSourceLink: 'https://github.com/g0v/moedict-data-hakka', // Put a link to the source material for your words here
  //
